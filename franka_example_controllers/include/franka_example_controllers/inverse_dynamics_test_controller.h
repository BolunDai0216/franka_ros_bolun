...
class InverseDynamicsTestController : public controller_interface::MultiInterfaceController<franka_hw::FrankaModelInterface, 
 ...
 private:
  ...
  Eigen::Matrix<double, 6, 1> dP_error;
